...
export default function AuthModal({ isOpen, onClose, initialTab = "login" }: AuthModalProps) {
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      if (err.message === "auth/wrong-password" || err.code === "auth/wrong-password" || err.code === "auth/invalid-credential") {
  ...
  const handleQuickDemoLogin = async () => {
    ...
    try {
      if (tab === "login") {
        await loginWithEmail("teacher@mindhub.ai", "password123");
      } else {
        await signUpWithEmail("teacher@mindhub.ai", "password123", "Sarah Jenkins");
      }
      onClose();
      router.push("/dashboard");
    } catch (err: any) {
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "16px",
          padding: "32px",
          boxShadow: "0 20px 50px rgba(0, 0, 0, 0.4), 0 0 30px -10px rgba(184, 140, 255, 0.2)",
          display: "flex",
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ fontSize: "0.875rem", color: "#ccc3d4", marginTop: "6px", marginBottom: 0 }}>
            {tab === "login"
              ...
              : "Start optimizing classroom learning paths"}
          </p>
        </div>
          ...
          >
            <div style={{ display: "flex", gap: "8px", alignItems: "flex-start" }}>
              ...
              <span style={{ fontSize: "0.775rem", color: "#ccc3d4", lineHeight: "1.4" }}>
                <strong style={{ color: "#d6baff" }}>Demo Mode Active:</strong> Firebase is running locally without keys. Click the button below to sign in instantly with mock data.
              </span>
            </div>
            <button
              type="button"
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "rgba(214, 186, 255, 0.2)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = "rgba(214, 186, 255, 0.12)";
              }}
            >
              <span className="material-symbols-outlined" style={{ fontSize: "16px" }}>bolt</span>
              Quick Bypass / Dev Login
            </button>
          </div>
        )}
        ...
        >
          <button
            ...
            style={{
              ...
              border: "none",
              cursor: "pointer",
              background: tab === "login" ? "rgba(214, 186, 255, 0.1)" : "transparent",
              color: tab === "login" ? "#d6baff" : "#ccc3d4",
              transition: "all 0.2s",
            }}
          >
            Log In
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              cursor: "pointer",
              background: tab === "signup" ? "rgba(214, 186, 255, 0.1)" : "transparent",
              color: tab === "signup" ? "#d6baff" : "#ccc3d4",
              transition: "all 0.2s",
            }}
          >
            Sign Up
